...
class FlaggerTests: XCTestCase {
    ...
    func testSetEntity() {
        ...
        XCTAssertFalse(Flagger.isEnabled(codename: "group-messaging"))
        Flagger.setEntity(entity)
        XCTAssert(Flagger.isEnabled(codename: "group-messaging")) // entity is provided by setEntity
    ...
    func testFlagIsEnabled() throws {
        Flagger.setEntity(nil)
        XCTAssert(Flagger.isEnabled(codename: "group-messaging", entity: Entity(id: "57145770")))
        XCTAssertFalse(Flagger.isEnabled(codename: "group-messaging"))
        
        // group example
        XCTAssert(Flagger.isEnabled(codename: "group-messaging", entity: Entity(id: "randomid", group: Group(id: "4576815", type: "Company"))))
    }
    
    func testFlagIsSampled() {
        let attributes: Attributes = Attributes().put(key:"createdAt", value:"2014-09-20T00:00:00Z")
        XCTAssertTrue(Flagger.isSampled(codename: "company-profiles", entity: Entity(id: "9139fdsds5", attributes: attributes)))
        
        // group example
        XCTAssertTrue(Flagger.isSampled(codename: "org-chart", entity: Entity(id: "41", type: "User", group: Group(id:"543", type:"Company"))))
    }
    
    func testFlagGetVariation() {
        XCTAssertEqual(Flagger.getVariation(codename: "group-messaging", entity: Entity(id: "57145770", type: "User")), "enabled")
    }
    
    func testFlagGetPayload() throws {
        let payload =  Flagger.getPayload(codename: "faq-redesign", entity: Entity(id: "92784783"))
